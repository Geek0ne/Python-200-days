...
>
> 每行 `[ ]` 方框 = 1 次 commit，写好代码/笔记后提交。
> 周末/假期每天 **8~15+ commits**，按知识点粒度推进。

---

## 第 1 个月：核心能力速成

### 第 1 周 · Python 基础速通（~20 commits）
...
### 第 7 周 · 深度学习基础 PyTorch（~20 commits）
...
### 第 8 周 · AI 延伸 + 数据+安全交叉（~18 commits）
...
### 第 15 周 · 综合项目 I — 企业资产监控系统（~15 commits）
...
### 第 16 周 · 综合项目 II — AI 赋能反爬数据平台（~15 commits）
...
| 阶段 | 节 | 预计 commits |
|------|-----|-------------|
| 第 1 周 · Python 基础 | 1.1~1.6 | ~20 |
| 第 2 周 · 网络+多线程 | 2.1~2.6 | ~22 |
| 第 3 周 · 数据库 | 3.1~3.6 | ~18 |
| 第 4 周 · OOP+工程化 | 4.1~4.6 | ~20 |
| 第 5 周 · 数据分析 | 5.1~5.6 | ~20 |
| 第 6 周 · 机器学习 | 6.1~6.6 | ~20 |
| 第 7 周 · 深度学习 | 7.1~7.6 | ~20 |
| 第 8 周 · AI 延伸 | 8.1~8.6 | ~18 |
| 第 9 周 · 爬虫核心 | 9.1~9.6 | ~20 |
| 第 10 周 · 反爬对抗 | 10.1~10.6 | ~18 |
| 第 11 周 · 网络安全 | 11.1~11.6 | ~18 |
| 第 12 周 · 安全工具 | 12.1~12.6 | ~18 |
| 第 13 周 · 自动化运维 | 13.1~13.6 | ~18 |
| 第 14 周 · DevOps | 14.1~14.6 | ~18 |
| 第 15 周 · 综合项目 I | 15.1~15.12 | ~12 |
| 第 16 周 · 综合项目 II | 16.1~16.13 | ~13 |
| **总计** | | **~295** |
...
| 假期类型 | 日 commits | 推荐范围 |
|---------|-----------|---------|
| 半天 | 8~10 | 1 个 Day（如 Day 1 全部） |
| 全天 | 12~15 | 1.5~2 个 Day |
| 小长假 | 10~13/天 | 半周~1 周内容 |
| 长假 | 12~15/天 | 1~2 周内容 |

## 进度追踪

每次学习结束时更新 `PROGRESS.md`，标记已完成的 `[ ]` 为 `[x]`。
